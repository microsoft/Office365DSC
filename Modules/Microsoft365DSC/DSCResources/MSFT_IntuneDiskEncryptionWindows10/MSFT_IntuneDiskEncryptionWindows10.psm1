function Get-TargetResource
{
    ...
    try
    {
        ...
        if ($PSBoundParameters.ContainsKey('Id'))
        {
            ...
            {
                Write-Verbose -Message "No Intune Disk Encryption for Windows10 with Id {$Id} was found"
                $getValue = Get-MgBetaDeviceManagementConfigurationPolicy -All -Filter "Name eq '$DisplayName' and templateReference/TemplateId eq '$templateReferenceId'"
        ...
        {
            Write-Verbose -Message "No Intune Disk Encryption for Windows10 with Name {$DisplayName} were found"
