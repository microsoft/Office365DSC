function Get-TargetResource
{
    ...
    try
    {
        ...
        if ($PSBoundParameters.ContainsKey('Id'))
        {
            ...
            {
                Write-Verbose -Message "No Intune Endpoint Detection And Response Policy Linux with Id {$Id} was found"
        ...
        {
            Write-Verbose -Message "No Intune Endpoint Detection And Response Policy Linux with Name {$DisplayName} were found"
