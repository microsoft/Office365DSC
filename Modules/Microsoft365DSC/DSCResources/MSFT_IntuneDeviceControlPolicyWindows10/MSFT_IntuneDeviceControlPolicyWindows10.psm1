function Get-TargetResource
{
    ...
    try
    {
        ...
        if ($PSBoundParameters.ContainsKey('Id'))
        {
            ...
            {
                Write-Verbose -Message "No Intune Device Control Policy for Windows10 with Id {$Id} was found"
        ...
        {
            Write-Verbose -Message "No Intune Device Control Policy for Windows10 with Name {$DisplayName} were found"
