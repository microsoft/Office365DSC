function Get-TargetResource
{
    ...
    try
    {
        ...
        if ($PSBoundParameters.ContainsKey('Id'))
        {
            ...
            {
                Write-Verbose -Message "No Intune Endpoint Detection And Response Policy MacOS with Id {$Id} was found"
        ...
        {
            Write-Verbose -Message "No Intune Endpoint Detection And Response Policy MacOS with Name {$DisplayName} were found"
